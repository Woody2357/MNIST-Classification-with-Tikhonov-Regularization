...
num_pcas = 1:50;
num_misclassified = zeros(1,length(num_pcas));
for i = num_pcas
    Xpca = X*U(:,1:i); % features
    ...
    num_misclassified(i) = nmisses;
end

figure;
plot(num_pcas,num_misclassified,'Linewidth',2);
xlabel('Number of PCA components','fontsize',fsz);
ylabel('Number of misclassified test samples','fontsize',fsz);
